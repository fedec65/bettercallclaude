...
Replace `<ABSOLUTE_PATH>` with the full path to the bettercallclaude repository root (e.g., `/Users/you/bettercallclaude`).
...
Download `.mcpb` bundle files from the [GitHub Releases page](https://github.com/fedec65/bettercallclaude/releases) and double-click each one to install directly into Claude Desktop.
